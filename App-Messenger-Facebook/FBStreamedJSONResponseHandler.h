...
@class FBReceivedChunkedDataMemoryBuffer, FBResponseProcessor, FBResponseProcessorConfiguration, NSHTTPURLResponse, NSObject<OS_dispatch_queue>, NSString;

@interface FBStreamedJSONResponseHandler : NSObject <FBResponseProcessorDelegate, FBReceivedDataBufferDelegate, FBResponseHandling>
{
