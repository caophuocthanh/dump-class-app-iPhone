...
#import "FBImportedContactRemovalListener.h"
...
@property(retain, nonatomic) NSArray *accumulatedImportedContactsFromCurrentImport; // @synthesize accumulatedImportedContactsFromCurrentImport=_accumulatedImportedContactsFromCurrentImport;
@property(retain, nonatomic) NSArray *accumulatedImportedContacts; // @synthesize accumulatedImportedContacts=_accumulatedImportedContacts;
- (void).cxx_destruct;
