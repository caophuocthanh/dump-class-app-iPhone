...
#import "FBCacheHandlerLogger.h"
#import "FBReachabilityListener.h"

@class FBAllocationTrackerLogger, FBAnalytics, FBAppStateLogger, FBApplicationStatusProvider, FBApplicationStatusSnapshot, FBCPUInfoProvider, FBOOMArchiver, FBRadioTechnologyFetcher, FBReachabilityAnnouncer, FBStateTimeIntervalsManager, NSFileManager, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;
