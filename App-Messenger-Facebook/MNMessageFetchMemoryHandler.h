...
@interface MNMessageFetchMemoryHandler : NSObject <MNMessageFetchRequestHandling>
{
    id <MNMessageFetchRequestHandling> _nextHandler;
    id <MNThreadMessageStoring> _messageStore;
...
- (id)initWithMemoryMessageStore:(id)arg1 queue:(id)arg2;
