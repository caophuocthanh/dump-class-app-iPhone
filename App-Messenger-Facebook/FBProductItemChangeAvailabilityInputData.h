...
@interface FBProductItemChangeAvailabilityInputData : FBGraphQLInput
{
...
@property(copy, nonatomic) NSString *productAvailability; // @synthesize productAvailability=_productAvailability;
