...
#import "FBPaymentsCardTextInputHandlerDelegate.h"

@class FBPaymentsCardTextInputHandler, FBPaymentsCardTextInputState, NSString, UIImage, UIImageView, UILabel, UITextField;
...
@property(readonly, copy, nonatomic) FBPaymentsCardTextInputState *currentTextInputState; // @synthesize currentTextInputState=_currentTextInputState;
...
@property(nonatomic) __weak id <FBPaymentsCardTextAndImageViewDelegate> delegate; // @synthesize delegate=_delegate;
