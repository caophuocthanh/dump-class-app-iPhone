...
+ (void)springOnLayer:(id)arg1 animation:(unsigned int)arg2 fromFrame:(struct CGRect)arg3 toFrame:(struct CGRect)arg4 completionBlock:(CDUnknownBlockType)arg5;
