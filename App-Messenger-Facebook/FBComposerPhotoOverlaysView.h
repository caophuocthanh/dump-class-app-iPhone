...
#import "FBComposerPhotoOverlayAttachmentGestureHandlerDelegate.h"
#import "FBComposerPhotoOverlaysViewProtocol.h"
#import "FBMediaGalleryTopBarDelegate.h"
#import "UIGestureRecognizerDelegate.h"

@class FBComposerPhotoOverlayGestureHandlerFactory, FBComposerPhotoOverlayView, FBMediaGallerySecondaryBar, FBMediaGalleryTopBar, FBMediaGalleryTopBarConfiguration, FBMediaTopNavigationBar, FBUserSession, NSMutableOrderedSet, NSString, UIButton<FBComposerPhotoOverlayAddDeleteButtonProtocol>, UIImage, UIImageView, UILabel;
...
- (void)layoutSubviews;
- (id)getOverlayLayer;
- (id)initWithFrame:(struct CGRect)arg1 photoOverlayLayer:(id)arg2 backgroundImage:(id)arg3 imageRotation:(float)arg4 showFullBleedPhoto:(BOOL)arg5 style:(unsigned int)arg6 topBarConfiguration:(id)arg7 session:(id)arg8 logger:(id)arg9 assetID:(id)arg10 bannerView:(id)arg11 privacyMessageView:(id)arg12;
