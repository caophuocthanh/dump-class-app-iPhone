...
@property(nonatomic) __weak id <MNRegistrationConfirmationCodeVerificationRequestSenderDelegate> delegate; // @synthesize delegate=_delegate;
@property(readonly, copy, nonatomic) id <FBPhoneNumber> phoneNumber; // @synthesize phoneNumber=_phoneNumber;
- (void).cxx_destruct;
