...
@class FBPrivacyScopeEditInputDataPrivacy, NSString;

@interface FBPrivacyScopeEditInputData : FBGraphQLInput
{
    NSString *_clientMutationId;
    NSString *_actorId;
    NSString *_nodeId;
    FBPrivacyScopeEditInputDataPrivacy *_privacy;
}

@property(copy, nonatomic) FBPrivacyScopeEditInputDataPrivacy *privacy; // @synthesize privacy=_privacy;
