...
- (void)fetchSharedMediaWithThreadKey:(id)arg1 afterCursor:(id)arg2 numItemsToFetch:(unsigned int)arg3 successBlock:(CDUnknownBlockType)arg4 failureBlock:(CDUnknownBlockType)arg5;
- (void)dealloc;
