...
@interface MNThreadContextElementFactory : NSObject <MNMessageSupplementaryElementFactory, FBClassProvidable>
{
    id <FBProvider> _threadContextViewControllerProvider;
}
...
- (id)initWithThreadContextViewControllerProvider:(id)arg1;
