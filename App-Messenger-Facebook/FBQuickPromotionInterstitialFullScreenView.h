...
@property(retain, nonatomic) FBQuickPromotionInterstitialSubtleButtonBarView *subtleButtonBarView; // @synthesize subtleButtonBarView=_subtleButtonBarView;
@property(retain, nonatomic) FBQuickPromotionInterstitialHorizontalButtonBarView *horizontalButtonBarView; // @synthesize horizontalButtonBarView=_horizontalButtonBarView;
