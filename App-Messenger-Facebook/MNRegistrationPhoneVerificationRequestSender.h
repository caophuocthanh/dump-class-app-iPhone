...
+ (id)requestParametersWithPhoneNumber:(id)arg1;
@property(nonatomic) __weak id <MNRegistrationPhoneVerificationRequestSenderDelegate> delegate; // @synthesize delegate=_delegate;
