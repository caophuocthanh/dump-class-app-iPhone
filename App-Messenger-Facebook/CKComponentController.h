...
@interface CKComponentController : NSObject
{
    ...
    struct vector<CKAppliedComponentAnimation, std::__1::allocator<CKAppliedComponentAnimation>> _appliedAnimationsOnInitialMount;
    struct vector<CKPendingComponentAnimation, std::__1::allocator<CKPendingComponentAnimation>> _pendingAnimations;
    struct vector<CKAppliedComponentAnimation, std::__1::allocator<CKAppliedComponentAnimation>> _appliedAnimations;
