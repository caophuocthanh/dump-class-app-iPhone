...
@interface FBMSPPagesManagerEventDeltaHandler : NSObject <FBSessionClassProvidable, FBMSPDeltaHandling>
{
...
- (void)_updateDataFromJSON:(id)arg1 deltaData:(id)arg2 jsonNError:(id)arg3 completion:(CDUnknownBlockType)arg4;
