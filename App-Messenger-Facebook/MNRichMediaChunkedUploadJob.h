...
@class FBGraphRequest, MNRichMediaContent, MNRichMediaUploadConfig, MNRichMediaUploadMetricsBuilder, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
