...
@interface FBMSPMuteSettingsDeltaHandler : NSObject <FBSessionClassProvidable, FBMSPDeltaHandling>
{
...
- (void)_processThreadMuteFromDeltaData:(id)arg1 completion:(CDUnknownBlockType)arg2;
