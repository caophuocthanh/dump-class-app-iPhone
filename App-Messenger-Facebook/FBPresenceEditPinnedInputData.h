...
@interface FBPresenceEditPinnedInputData : FBGraphQLInput
{
    NSString *_clientMutationId;
    NSString *_actorId;
    NSArray *_pinnedUsers;
}

@property(copy, nonatomic) NSArray *pinnedUsers; // @synthesize pinnedUsers=_pinnedUsers;
