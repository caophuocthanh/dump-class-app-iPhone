...
@class MNMessagesSyncFailedSend, NSMutableArray, NSString;
...
@property(retain, nonatomic, getter=failedSend, setter=setFailedSend:) MNMessagesSyncFailedSend *failedSend;
