...
@property(readonly, copy, nonatomic) FBEncoderConfig *encoderConfig; // @synthesize encoderConfig=_encoderConfig;
...
- (void).cxx_destruct;
- (id)initWithPerformStandardization:(BOOL)arg1 videoCompressionSettings:(id)arg2 audioCompressionSettings:(id)arg3 maxAvgVideoBitrateSD:(unsigned int)arg4 maxAvgVideoBitrateHD:(unsigned int)arg5 preferredResolution:(unsigned int)arg6 encoderConfig:(id)arg7;
