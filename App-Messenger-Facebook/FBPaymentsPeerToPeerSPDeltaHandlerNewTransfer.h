...
{
    id <FBPaymentsPeerToPeerTransferCoordinatorDataMutator> _paymentTransfersDataMutator;
...
- (id)initWithPaymentTransfersDataMutator:(id)arg1 transferOfflineDeltaHandler:(id)arg2;
- (id)init;
