...
@interface FBApplicationRequestAcceptInputData : FBGraphQLInput
{
...
@property(copy, nonatomic) NSString *deviceIdIfJustInstalled; // @synthesize deviceIdIfJustInstalled=_deviceIdIfJustInstalled;
