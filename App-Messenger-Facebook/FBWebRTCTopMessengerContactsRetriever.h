...
@interface FBWebRTCTopMessengerContactsRetriever : NSObject <MNTopAndFavoriteFriendsFetcherDelegate, MNSuggestedContactsRetriever, FBClassProvidable>
{
...
- (id)_filterAndSortFriends:(id)arg1;
