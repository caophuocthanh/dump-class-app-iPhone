...
- (void)observe:(id)arg1 keyPath:(id)arg2 options:(unsigned int)arg3 context:(void *)arg4;
- (void)observe:(id)arg1 keyPath:(id)arg2 options:(unsigned int)arg3 action:(SEL)arg4;
- (void)observe:(id)arg1 keyPath:(id)arg2 options:(unsigned int)arg3 block:(CDUnknownBlockType)arg4;
- (void)_unobserveAll;
