...
@interface FBRedspaceStoryViewInputData : FBGraphQLInput
{
    NSString *_clientMutationId;
    NSString *_actorId;
    NSString *_storyId;
    NSString *_spaceOwnerId;
}

@property(copy, nonatomic) NSString *spaceOwnerId; // @synthesize spaceOwnerId=_spaceOwnerId;
