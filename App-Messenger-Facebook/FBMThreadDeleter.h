...
@class FBMDetchedNetworkRequestsQueue, FBMThreadSummary, FBSimpleNetworkerRequest, FBUserSession, MNMessagingRegionHeaderHelper, NSString;

@interface FBMThreadDeleter : NSObject <FBNetworkerRequestDelegate, FBClassProvidable, FBCancelable, FBMDetachable>
{
    ...
    id <FBMThreadDeleterDelegate> _delegate;
...
- (void)detach;
- (void)cancel;
- (void)deleteThreadSummary:(id)arg1 withDelegate:(id)arg2;
