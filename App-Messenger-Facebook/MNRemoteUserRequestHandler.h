...
@class FBNetworkActivityManager, MNRemoteMultipleUserRequestRunner, MNRemoteSingleUserRequestRunner, NSString;
...
- (id)initWithNetworkActivityManager:(id)arg1 userFetcherCreationBlock:(CDUnknownBlockType)arg2;
- (id)init;
