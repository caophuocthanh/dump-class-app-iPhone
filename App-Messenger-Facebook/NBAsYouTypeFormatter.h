...
@property(nonatomic) unsigned int positionToRemember_; // @synthesize positionToRemember_=_positionToRemember_;
@property(nonatomic) unsigned int originalPosition_; // @synthesize originalPosition_=_originalPosition_;
@property(nonatomic) unsigned int lastMatchPosition_; // @synthesize lastMatchPosition_=_lastMatchPosition_;
...
- (unsigned int)getRememberedPosition;
