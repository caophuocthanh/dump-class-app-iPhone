...
@class FBMNetworkProtocolController, FBMSPThreadUpdater, NSString;

@interface FBMSPBroadcastMessageDeltaHandler : NSObject <FBSessionClassProvidable, FBMSPDeltaHandling>
{
...
- (void)_processMessageMetadata:(id)arg1 fromDeltaData:(id)arg2 completion:(CDUnknownBlockType)arg3;
