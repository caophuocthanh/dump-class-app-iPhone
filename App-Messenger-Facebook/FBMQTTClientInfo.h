...
@property(nonatomic, getter=clientStack, setter=setClientStack:) unsigned char clientStack;
- (void)unsetDeviceSecret;
- (BOOL)deviceSecretIsSet;
@property(retain, nonatomic, getter=deviceSecret, setter=setDeviceSecret:) NSString *deviceSecret;
