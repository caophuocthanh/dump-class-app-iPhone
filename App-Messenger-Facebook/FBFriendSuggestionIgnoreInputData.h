...
@interface FBFriendSuggestionIgnoreInputData : FBGraphQLInput
{
...
@property(copy, nonatomic) NSString *suggestedFriendId; // @synthesize suggestedFriendId=_suggestedFriendId;
