...
@class FBNuxToolTip, FBNuxToolTipView, NSString, UITapGestureRecognizer;
...
@property(retain, nonatomic) FBNuxToolTipView *toolTipView; // @synthesize toolTipView=_toolTipView;
