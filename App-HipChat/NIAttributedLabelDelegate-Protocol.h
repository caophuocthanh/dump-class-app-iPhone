...
@optional
- (BOOL)attributedLabel:(NIAttributedLabel *)arg1 shouldPresentActionSheet:(UIActionSheet *)arg2 withTextCheckingResult:(NSTextCheckingResult *)arg3 atPoint:(struct CGPoint)arg4;
