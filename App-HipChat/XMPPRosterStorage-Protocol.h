...
@class DDXMLElement, NSArray, NSObject<OS_dispatch_queue>, UIImage, XMPPJID, XMPPPresence, XMPPRoster, XMPPStream;
...
- (BOOL)configureWithParent:(XMPPRoster *)arg1 queue:(NSObject<OS_dispatch_queue> *)arg2;
