...
@class NRPLCrashMachExceptionPortSet, NRPLCrashMachExceptionServer, NRPLCrashReporterConfig, NSString;

@interface NRPLCrashReporter : NSObject
{
    NRPLCrashReporterConfig *_config;
    BOOL _enabled;
    NRPLCrashMachExceptionServer *_machServer;
    NRPLCrashMachExceptionPortSet *_previousMachPorts;
