...
- (void)prepareRender:(struct CGSize)arg1 red:(float)arg2 green:(float)arg3 blue:(float)arg4 alpha:(float)arg5;
...
- (void)dealloc;
- (id)initWithService:(id)arg1 withView:(id)arg2 withAsync:(BOOL)arg3;
