...
{
    MZFormSheetController *_formSheetController;
}

@property(retain, nonatomic) MZFormSheetController *formSheetController; // @synthesize formSheetController=_formSheetController;
- (void).cxx_destruct;
- (void)perform;
