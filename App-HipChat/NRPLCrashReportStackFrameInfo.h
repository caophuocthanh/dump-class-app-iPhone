...
@class NRPLCrashReportSymbolInfo;

@interface NRPLCrashReportStackFrameInfo : NSObject
{
    unsigned long long _instructionPointer;
    NRPLCrashReportSymbolInfo *_symbolInfo;
}

@property(readonly, nonatomic) NRPLCrashReportSymbolInfo *symbolInfo; // @synthesize symbolInfo=_symbolInfo;
