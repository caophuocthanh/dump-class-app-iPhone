...
@class FABApplicationIdentiferModel, FABOnboardingOperation, FABSettings, NSDictionary, NSFileManager, NSString;
...
@property(copy, nonatomic) NSDictionary *kitVersions; // @synthesize kitVersions=_kitVersions;
