...
@class DDXMLElement, NSObject<OS_dispatch_queue>, NSString, XMPPCapabilities, XMPPJID, XMPPStream;
...
- (BOOL)configureWithParent:(XMPPCapabilities *)arg1 queue:(NSObject<OS_dispatch_queue> *)arg2;
