...
@class NSMutableDictionary, NSString, PSPDFDatabase, PSPDFStatement;

@interface PSPDFResultSet : NSObject
{
    PSPDFDatabase *_parentDB;
    NSMutableDictionary *_columnNameToIndexMap;
    NSString *_query;
    PSPDFStatement *_statement;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) PSPDFStatement *statement; // @synthesize statement=_statement;
...
- (BOOL)hasAnotherRow;
- (BOOL)nextWithErrorLogEnabled:(BOOL)arg1;
- (BOOL)next;
- (id)resultDictionary;
