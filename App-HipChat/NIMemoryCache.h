...
- (BOOL)containsObjectWithName:(id)arg1;
...
- (BOOL)shouldSetObject:(id)arg1 withName:(id)arg2 previousObject:(id)arg3;
- (BOOL)willSetObject:(id)arg1 withName:(id)arg2 previousObject:(id)arg3;
