...
- (id)sd_imageURL;
- (void)sd_setImageWithPreviousCachedImageWithURL:(id)arg1 andPlaceholderImage:(id)arg2 options:(unsigned int)arg3 progress:(CDUnknownBlockType)arg4 completed:(CDUnknownBlockType)arg5;
- (void)sd_setImageWithURL:(id)arg1 placeholderImage:(id)arg2 options:(unsigned int)arg3 progress:(CDUnknownBlockType)arg4 completed:(CDUnknownBlockType)arg5;
