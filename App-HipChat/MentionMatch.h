...
@interface MentionMatch : NSObject <MessageParserMatchResult>
{
...
- (BOOL)isPartialMatch;
- (BOOL)isFullMatch;
- (id)initWithSourceString:(id)arg1 matchString:(id)arg2 matchRange:(struct _NSRange)arg3 matchType:(unsigned int)arg4;
