...
@class FBComposerPublisherData, FBGraphQLMutationHandle, FBUserSession, NSString;

@interface FBComposerReviewPublisher : NSObject <FBComposerPublisher>
{
...
- (void)_attemptSendingPublisherData:(id)arg1;
