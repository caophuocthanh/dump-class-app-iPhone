...
@class FBAnalytics, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (CDStruct_4bcfbbae)_finishPrefetch:(id)arg1;
- (void)_flushPendingEvents;
- (void)_queueEvent:(id)arg1 cacheKey:(id)arg2 withTimeInterval:(CDStruct_4bcfbbae)arg3 withBytesCount:(id)arg4 failureReason:(id)arg5 prefetchBatchId:(id)arg6;
