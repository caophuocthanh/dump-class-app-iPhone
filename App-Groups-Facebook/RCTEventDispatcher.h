...
@class NSLock, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, RCTBridge;
...
- (void)sendTextEventWithType:(int)arg1 reactTag:(id)arg2 text:(id)arg3 eventCount:(int)arg4;
