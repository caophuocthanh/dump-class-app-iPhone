...
@class FBDelayServicesOnColdStartExperimentContext, FBMQTTClientManager, FBUserSession, NSNotificationCenter, NSObject<OS_dispatch_queue>, NSSet, NSString, NSUserDefaults, UIApplication, VOIPConfiguration, VOIPConfigurationChecker;
