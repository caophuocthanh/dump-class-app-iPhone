...
@interface FBGroupsBlockedUsersDataSource : NSObject <FBGroupsDataSourceProtocol, FBGroupsMembersDataSourceProtocol, UITableViewDataSource, UITableViewDelegate>
{
    NSString *_groupID;
