...
- (void)cacheData:(id)arg1 toDiskForKey:(id)arg2 withExtendedInfo:(shared_ptr_b0a1ff5c)arg3 queue:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;
...
- (id)initWithDiskCache:(shared_ptr_192c94b6)arg1;
