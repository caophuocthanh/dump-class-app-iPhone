...
@class FBBoostedComponentCreateInputDataCreativeObjectStorySpecLinkDataCallToAction, NSArray, NSString;
...
@property(copy, nonatomic) FBBoostedComponentCreateInputDataCreativeObjectStorySpecLinkDataCallToAction *callToAction; // @synthesize callToAction=_callToAction;
