...
@class FBActivitySharingComposition, FBActivitySharingGenericSearchField, FBActivitySharingInactiveSearchField, FBActivitySharingTableViewCellFactory, FBPlacePickerBaseViewController, FBPlacePickerV2NearbyFetcher, FBUserSession, NSString, UIViewController;
