...
- (id)init;
- (id)initWithReplacementModel:(id)arg1 lifecycleManager:(id)arg2 constrainedSize:(struct CKSizeRange)arg3 oldSize:(struct CGSize)arg4 UUID:(id)arg5 sourceIndexPath:(id)arg6 destinationIndexPath:(id)arg7 changeType:(unsigned int)arg8 passthrough:(BOOL)arg9 context:(id)arg10;
