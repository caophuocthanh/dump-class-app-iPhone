...
@class FBBugReportContainerView, FBBugReportCoordinator, FBBugReportShakeHandler, NSString, NSTimer, UIViewController<FBBugReportContainerViewControllerChildViewControllerDelegate>;
