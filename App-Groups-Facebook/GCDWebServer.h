...
@property(readonly, nonatomic) BOOL shouldAutomaticallyMapHEADToGET; // @synthesize shouldAutomaticallyMapHEADToGET=_mapHEADToGET;
...
- (int)_createListeningSocket:(BOOL)arg1 localAddress:(const void *)arg2 length:(unsigned int)arg3 maxPendingConnections:(unsigned int)arg4 error:(id *)arg5;
...
- (void)dealloc;
- (id)init;
- (BOOL)startWithPort:(unsigned int)arg1 bonjourName:(id)arg2;
- (BOOL)start;
...
- (void)addGETHandlerForBasePath:(id)arg1 directoryPath:(id)arg2 indexFilename:(id)arg3 cacheAge:(unsigned int)arg4 allowRangeRequests:(BOOL)arg5;
- (id)_responseWithContentsOfDirectory:(id)arg1;
- (void)addGETHandlerForPath:(id)arg1 filePath:(id)arg2 isAttachment:(BOOL)arg3 cacheAge:(unsigned int)arg4 allowRangeRequests:(BOOL)arg5;
- (void)addGETHandlerForPath:(id)arg1 staticData:(id)arg2 contentType:(id)arg3 cacheAge:(unsigned int)arg4;
