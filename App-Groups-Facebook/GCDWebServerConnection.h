...
+ (void)initialize;
@property(readonly, nonatomic) unsigned int totalBytesWritten; // @synthesize totalBytesWritten=_bytesWritten;
@property(readonly, nonatomic) unsigned int totalBytesRead; // @synthesize totalBytesRead=_bytesRead;
...
- (void)_readBodyWithLength:(unsigned int)arg1 initialData:(id)arg2;
- (void)_finishProcessingRequest:(id)arg1;
- (void)_startProcessingRequest;
- (void)_initializeResponseHeadersWithStatusCode:(int)arg1;
...
- (void)_readBodyWithRemainingLength:(unsigned int)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)_readHeaders:(id)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;
- (void)_readData:(id)arg1 withLength:(unsigned int)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)close;
- (void)abortRequest:(id)arg1 withStatusCode:(int)arg2;
...
- (void)didWriteBytes:(const void *)arg1 length:(unsigned int)arg2;
- (void)didReadBytes:(const void *)arg1 length:(unsigned int)arg2;
- (BOOL)open;
