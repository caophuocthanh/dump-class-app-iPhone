...
#import "FBComposerContentSuggestionPopoverControllerDelegate.h"
#import "FBComposerMentionHosting.h"
#import "FBComposerOpenAnimationLayoutProvider.h"
#import "FBComposerTextViewDelegate.h"
#import "FBComposerTextViewDraggableKeyboardDelegate.h"
#import "FBKeyboardObserverDelegate.h"
#import "FBQAndALabelViewDelegate.h"
#import "FBTargetingLabelViewDelegate.h"

@class CAGradientLayer, CKComponentHostingView, FBComposerActivityAttachment, FBComposerAddAlbumView, FBComposerAdditionalInfoButton, FBComposerAttachment, FBComposerAuthor, FBComposerChoosersBar, FBComposerContentSuggestionPopoverController, FBComposerEventDate, FBComposerGroupCommerceSellItemView, FBComposerHighlightedText, FBComposerMediaView, FBComposerPostCompositionNUXView, FBComposerRedSpaceToggleView, FBComposerTextView, FBComposerThumbListView, FBComposerThumbnailPile, FBCompositionLinkShare, FBKeyboardObserver, FBQAndALabelView, FBReviewComposerAnimationController, FBReviewComposerRatingView, FBTargetingLabelView, FBUserSession, NSString, UIGestureRecognizer, UIView<FBComposerContentViewLayoutProtocol>;
...
@interface FBComposerView : UIView <FBComposerTextViewDelegate, FBKeyboardObserverDelegate, CKComponentHostingViewDelegate, FBComposerTextViewDraggableKeyboardDelegate, FBComposerContentSuggestionPopoverControllerDelegate, FBAccessibilityInvalidationEventsListener, FBQAndALabelViewDelegate, FBTargetingLabelViewDelegate, FBComposerMentionHosting, FBComposerOpenAnimationLayoutProvider>
{
    ...
    FBComposerRedSpaceToggleView *_redSpaceToggleView;
    FBReviewComposerRatingView *_reviewComposerRatingView;
    FBReviewComposerAnimationController *_reviewComposerAnimationController;
    BOOL _isEditingText;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)updateRedSpacePostEnabled:(BOOL)arg1;
...
- (void)updateStarRating:(unsigned int)arg1;
...
- (BOOL)_shouldHideRedSpaceToggle;
...
- (void)updateQuestionLabelText:(id)arg1;
