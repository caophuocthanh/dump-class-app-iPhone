...
@interface FBReactionUnitUserSettingsDisableUnitTypeInputData : FBGraphQLInput
{
...
@property(copy, nonatomic) NSString *unitTypeToken; // @synthesize unitTypeToken=_unitTypeToken;
