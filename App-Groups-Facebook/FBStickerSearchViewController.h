...
#import "FBStickerSearchResultsControllerDelegate.h"
#import "FBStickerSearchTagsControllerDelegate.h"
#import "FBStickerSearchViewDelegate.h"
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithSession:(id)arg1 stickerManager:(id)arg2 stickerResourceManager:(id)arg3 layoutIdiom:(unsigned int)arg4;
