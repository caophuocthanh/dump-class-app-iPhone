...
@interface FBPageSavedResponseDeleteInputData : FBGraphQLInput
{
...
@property(copy, nonatomic) NSString *savedResponseId; // @synthesize savedResponseId=_savedResponseId;
