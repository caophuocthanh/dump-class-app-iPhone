...
#import "FBPlacePickerViewErrorControllerDelegate.h"

@class FBComposerPickerCurrentLabel, FBContentInsetTracker, FBPlacePickerViewErrorController, FBPullToRefreshView, FBUserSession, UITableView, UIView<FBPlacePickerSearchBarProtocol>;
