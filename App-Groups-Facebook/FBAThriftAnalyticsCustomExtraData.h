...
{
    struct NSMutableDictionary *__thrift_eventExtra;
...
@property(retain, nonatomic) NSMutableDictionary *eventExtra;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithEventExtra:(struct NSMutableDictionary *)arg1;
- (id)init;
