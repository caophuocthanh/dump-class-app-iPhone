...
@class FBPlacePickerNUXView, NSDictionary, NSString;

@interface FBPlacePickerNUXPresenter : NSObject <FBNuxPresenter>
{
    FBPlacePickerNUXView *_placePickerNUXView;
    BOOL _hasCheckin;
    id <FBNuxDelegate> _nuxCoordinator;
}

@property(nonatomic) BOOL hasCheckin; // @synthesize hasCheckin=_hasCheckin;
