...
#import "FBTranscodingHandlerDelegate.h"

@class AVAsset, AVAssetReader, AVAssetWriter, FBKVOController, FBMobileTraceAsyncTokenPtr, FBVideoExportConfig, NSError, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSURL;
