...
@class AVAssetReader, AVAssetReaderOutput, AVAssetTrack, AVAssetWriter, AVAssetWriterInput, CKComponent, CKComponentScopeRoot, FBComposerScopeSingletonProvider, FBDisplayableMediaViewProviderContext, FBGlobalScopeSingletonProvider, FBHScrollOffsetStore, FBImageDownloader, FBVideoExportConfig, FBWebViewResponse, NSArray, NSAttributedString, NSDictionary, NSError, NSString, NSURL, UIColor, UIFont, UIImage;
...
struct ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>;
...
struct PostCompositionContents {
    struct vector<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionItem *>, std::__1::allocator<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionItem *>>> updateItems;
    struct vector<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>, std::__1::allocator<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>>> railUpdateItems;
    unsigned int submitStyle;
    UIColor *postCompositionExtendedColor;
    unsigned int sheetStyle;
};
...
struct _FBAConfig {
    basic_string_7d00a7a9 appId;
    basic_string_7d00a7a9 appSecret;
    basic_string_7d00a7a9 appVersion;
    basic_string_7d00a7a9 deviceId;
    basic_string_7d00a7a9 logDirectory;
    basic_string_7d00a7a9 hostname;
...
struct _FBItemContentViewLayout {
    ...
    struct CGRect secondarySubtitleFrame;
    struct CGRect tertiarySubtitleFrame;
...
struct lazy_provider<FBComposerScopeSingletonProvider, FBComposerNuxInitialCoordinator *> {
    struct mutex _mutex;
    FBComposerScopeSingletonProvider *_provider;
    char _invalidated;
};
...
struct shared_ptr<facebook::mobile::graphstore::relay::GraphStoreRelayBridge> {
    struct GraphStoreRelayBridge *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
struct shared_ptr<facebook::mobile::xplat::executor::Executor> {
...
struct shared_ptr<std::__1::vector<unsigned char, std::__1::allocator<unsigned char>>> {
...
struct vector<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>, std::__1::allocator<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>>> {
    struct ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *> *__begin_;
    struct ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *> *__end_;
    struct __compressed_pair<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>*, std::__1::allocator<FBComposer::CollectionChangeSetUpdating::ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *>>> {
        struct ItemUpdateHandler<FBComposerCompositionState *, FBComposerPostCompositionRailItem *> *__first_;
    } __end_cap_;
};
...
typedef struct shared_ptr<facebook::mobile::graphstore::relay::GraphStoreRelayBridge> {
    struct GraphStoreRelayBridge *__ptr_;
    struct __shared_weak_count *__cntrl_;
} shared_ptr_19c615aa;
...
typedef struct shared_ptr<facebook::mobile::xplat::executor::Executor> {
    struct Executor *__ptr_;
    struct __shared_weak_count *__cntrl_;
} shared_ptr_a2eb2784;
...
typedef struct shared_ptr<std::__1::vector<unsigned char, std::__1::allocator<unsigned char>>> {
    struct vector<unsigned char, std::__1::allocator<unsigned char>> *_field1;
    struct __shared_weak_count *_field2;
} shared_ptr_0c5a9896;
