...
@class FBEventUpdateExtendedViewerWatchStatusInputDataContext, NSArray, NSString;
...
@property(copy, nonatomic) FBEventUpdateExtendedViewerWatchStatusInputDataContext *context; // @synthesize context=_context;
