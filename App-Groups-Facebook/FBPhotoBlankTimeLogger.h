...
- (void)webImageView:(id)arg1 logImageDidShowWithURL:(id)arg2 withImageFlag:(unsigned int)arg3 withImageWidth:(unsigned int)arg4 isCached:(BOOL)arg5 completed:(BOOL)arg6;
