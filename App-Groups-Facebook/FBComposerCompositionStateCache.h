...
#import "FBComposerCompositionStatePersister.h"
#import "FBObjectCachingListener.h"

@class FBSessionScopedFileCache, NSString;

@interface FBComposerCompositionStateCache : NSObject <FBObjectCachingListener, FBComposerCompositionStatePersister>
{
    FBSessionScopedFileCache *_cache;
    id <FBComposerCompositionStateCachingListener> _listener;
}
...
- (void)writeCompositionState:(id)arg1;
- (void)clear;
- (void)readCompositionState;
