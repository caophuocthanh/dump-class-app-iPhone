...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct CKComponentLayout)cachedLayout:(id)arg1 thatFits:(struct CKSizeRange)arg2 restrictedToSize:(struct CKComponentSize)arg3 parentSize:(struct CGSize)arg4;
