...
@property(nonatomic) unsigned int errorBehavior; // @synthesize errorBehavior=_errorBehavior;
...
- (void)cancel;
- (void)start;
- (void)addRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2 batchParameters:(id)arg3 behavior:(unsigned int)arg4;
