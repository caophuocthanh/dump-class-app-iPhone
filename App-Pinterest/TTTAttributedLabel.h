...
@property(nonatomic) BOOL extendsLinkTouchArea; // @synthesize extendsLinkTouchArea=_extendsLinkTouchArea;
...
- (void)drawFramesetter:(struct __CTFramesetter *)arg1 attributedString:(id)arg2 textRange:(CDStruct_3eb3f945)arg3 inRect:(struct CGRect)arg4 context:(struct CGContext *)arg5;
...
- (id)linkAtRadius:(float)arg1 aroundPoint:(struct CGPoint)arg2;
...
- (void)linkHashTags;
- (void)setAllLinkAttributes:(id)arg1;
- (void)addLinksUsingHTMLTags:(id)arg1;
