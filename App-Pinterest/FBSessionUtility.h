...
+ (id)audienceNameWithAudience:(unsigned int)arg1;
+ (id)userIDFromSignedRequest:(id)arg1;
+ (unsigned int)loginBehaviorForLoginType:(unsigned int)arg1;
...
+ (void)validateRequestForPermissions:(id)arg1 defaultAudience:(unsigned int)arg2 allowSystemAccount:(BOOL)arg3 isRead:(BOOL)arg4;
...
+ (id)sessionStateDescription:(unsigned int)arg1;
