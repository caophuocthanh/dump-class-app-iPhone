...
@class ASTextNodeWordKerner, NSArray, NSAttributedString, NSLayoutManager, NSTextContainer, NSTextStorage;
...
- (id)initWithAttributedString:(id)arg1 truncationString:(id)arg2 truncationMode:(int)arg3 maximumLineCount:(unsigned int)arg4 exclusionPaths:(id)arg5 constrainedSize:(struct CGSize)arg6;
