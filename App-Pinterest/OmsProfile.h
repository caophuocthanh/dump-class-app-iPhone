...
@interface OmsProfile : NSObject <TBase, NSCoding>
{
    long long __id;
    long long __merchantId;
    int __omsType;
    NSString *__externalOmsId;
    ...
    BOOL __omsType_isset;
    BOOL __externalOmsId_isset;
...
- (void)unsetExternalOmsId;
- (BOOL)externalOmsIdIsSet;
@property(retain, nonatomic, getter=externalOmsId, setter=setExternalOmsId:) NSString *externalOmsId;
- (void)unsetOmsType;
- (BOOL)omsTypeIsSet;
@property(nonatomic, getter=omsType, setter=setOmsType:) int omsType;
...
- (id)initWithId:(long long)arg1 merchantId:(long long)arg2 omsType:(int)arg3 externalOmsId:(id)arg4 displayName:(id)arg5 host:(id)arg6 createdAt:(long long)arg7 updatedAt:(long long)arg8 credential:(id)arg9;
- (id)init;
