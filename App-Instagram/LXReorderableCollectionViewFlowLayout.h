...
@property(nonatomic) BOOL selectedItemDeletePossible; // @synthesize selectedItemDeletePossible=_selectedItemDeletePossible;
@property(retain, nonatomic) NSIndexPath *selectedItemIndexPath; // @synthesize selectedItemIndexPath=_selectedItemIndexPath;
@property(nonatomic) float returnToCollectionAnimationDuration; // @synthesize returnToCollectionAnimationDuration=_returnToCollectionAnimationDuration;
