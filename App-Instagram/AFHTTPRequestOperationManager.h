...
@class AFHTTPRequestSerializer<AFURLRequestSerialization>, AFHTTPResponseSerializer<AFURLResponseSerialization>, AFNetworkReachabilityManager, AFSecurityPolicy, NSOperationQueue, NSURL, NSURLCredential;
