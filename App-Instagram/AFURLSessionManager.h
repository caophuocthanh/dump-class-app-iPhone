...
@class AFNetworkReachabilityManager, AFSecurityPolicy, NSArray, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
...
- (id)downloadTaskWithTask:(id)arg1 progress:(id *)arg2 destination:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)uploadTaskWithTask:(id)arg1 progress:(id *)arg2 completionHandler:(CDUnknownBlockType)arg3;
