...
- (id)initWithIsFollow:(BOOL)arg1 targetUserId:(long long)arg2 position:(long long)arg3 algorithm:(id)arg4 clickPoint:(id)arg5 errorMessage:(id)arg6 sectionNumber:(long long)arg7 clusterKey:(id)arg8;
- (id)init;
