...
- (id)initWithMarquee:(id)arg1 sectionNumber:(long long)arg2 position:(id)arg3 algorithm:(id)arg4 viewed:(BOOL)arg5 subImpression:(BOOL)arg6 clusterKey:(id)arg7;
- (id)init;
