...
@property(readonly, nonatomic) NSMutableDictionary *macroLookup; // @synthesize macroLookup=_macroLookup;
@property(readonly, nonatomic) NSSet *rules; // @synthesize rules=_rules;
@property(readonly, nonatomic) NSCache *macroEvaluationCache; // @synthesize macroEvaluationCache=_macroEvaluationCache;
@property(readonly, nonatomic) NSCache *functionCallCache; // @synthesize functionCallCache=_functionCallCache;
@property(readonly, nonatomic) NSMutableDictionary *macroMap; // @synthesize macroMap=_macroMap;
@property(readonly, nonatomic) NSMutableDictionary *predicateMap; // @synthesize predicateMap=_predicateMap;
@property(readonly, nonatomic) NSMutableDictionary *trackingTagMap; // @synthesize trackingTagMap=_trackingTagMap;
