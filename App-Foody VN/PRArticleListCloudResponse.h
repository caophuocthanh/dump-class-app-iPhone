...
@interface PRArticleListCloudResponse : CloudResponse
{
    Article *currentAricle;
    ImageResource *imageResource;
    NSMutableArray *imageResourceList;
    NSMutableArray *listPRArticle;
}

@property(retain, nonatomic) NSMutableArray *listPRArticle; // @synthesize listPRArticle;
