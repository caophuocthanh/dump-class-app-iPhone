...
@interface FoodyCardResponse : CloudResponse
{
    FoodyCard *currentCard;
}

@property(retain, nonatomic) FoodyCard *currentCard; // @synthesize currentCard;
- (void).cxx_destruct;
