...
@interface ActivityDetailResponse : CloudResponse
{
    NSString *activityPoint;
}

@property(copy, nonatomic) NSString *activityPoint; // @synthesize activityPoint;
- (void).cxx_destruct;
