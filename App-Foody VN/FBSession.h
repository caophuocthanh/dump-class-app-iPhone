...
- (void)fallbackFromSystemAuth:(id)arg1 defaultAudience:(unsigned int)arg2;
...
- (void)authorizeUsingSystemAccountStore:(id)arg1 defaultAudience:(unsigned int)arg2 isReauthorize:(BOOL)arg3 canFetchAppSettings:(BOOL)arg4;
