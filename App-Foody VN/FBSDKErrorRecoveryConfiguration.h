...
@property(readonly, nonatomic) unsigned int errorCategory; // @synthesize errorCategory=_errorCategory;
...
- (id)initWithRecoveryDescription:(id)arg1 optionDescriptions:(id)arg2 category:(unsigned int)arg3 recoveryActionName:(id)arg4;
- (id)init;
