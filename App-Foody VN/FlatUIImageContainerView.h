...
@interface FlatUIImageContainerView : UIView <UITextFieldDelegate, UITextViewDelegate>
{
    BOOL isAnimating;
    int inputTag;
    ...
    id <FlatUIImageContainerDelegate> _delegateImageContainer;
}

@property(nonatomic) __weak id <FlatUIImageContainerDelegate> delegateImageContainer; // @synthesize delegateImageContainer=_delegateImageContainer;
@property(nonatomic) BOOL isEditPhoto; // @synthesize isEditPhoto;
