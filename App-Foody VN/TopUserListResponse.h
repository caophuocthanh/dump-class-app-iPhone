...
@class ImageResource, NSMutableArray, User;

@interface TopUserListResponse : CloudPagingResponse
{
...
@property(retain, nonatomic) NSMutableArray *userList; // @synthesize userList;
