...
@interface FBAppEvents : NSObject
{
    ...
    unsigned int _appSettingsFetchState;
...
@property BOOL doesAppLogImplicitPurchaseEvents; // @synthesize doesAppLogImplicitPurchaseEvents=_doesAppLogImplicitPurchaseEvents;
@property BOOL shouldAccessAdvertisingID; // @synthesize shouldAccessAdvertisingID=_shouldAccessAdvertisingID;
@property BOOL appSupportsImplicitLogging; // @synthesize appSupportsImplicitLogging=_appSupportsImplicitLogging;
@property unsigned int appSettingsFetchState; // @synthesize appSettingsFetchState=_appSettingsFetchState;
...
- (void)flushEventsToServer:(unsigned int)arg1 session:(id)arg2;
...
- (void)fetchAppSettings:(CDUnknownBlockType)arg1;
- (void)dealloc;
- (id)init;
