...
+ (id)sessionForUnitTestingWithPermissions:(id)arg1 mode:(unsigned int)arg2 sessionUniqueUserTag:(id)arg3;
...
- (void)dealloc;
- (id)initWithAppID:(id)arg1 appSecret:(id)arg2 clientToken:(id)arg3 machineUniqueUserTag:(id)arg4 sessionUniqueUserTag:(id)arg5 mode:(unsigned int)arg6 permissions:(id)arg7 tokenCachingStrategy:(id)arg8;
