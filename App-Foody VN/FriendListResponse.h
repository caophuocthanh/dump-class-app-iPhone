...
@interface FriendListResponse : CloudPagingResponse
{
    BOOL isFriend;
    User *currentFriend;
    Photo *currentPhoto;
    ...
    NSMutableArray *currentFriendList;
}

@property(retain, nonatomic) NSMutableArray *currentFriendList; // @synthesize currentFriendList;
...
@property(retain, nonatomic) User *currentFriend; // @synthesize currentFriend;
@property(nonatomic) BOOL isFriend; // @synthesize isFriend;
- (void).cxx_destruct;
