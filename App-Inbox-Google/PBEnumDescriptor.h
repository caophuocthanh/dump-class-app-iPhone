...
+ (id)allocDescriptorForName:(id)arg1 values:(struct PBMessageEnumValueDescription *)arg2 valueCount:(unsigned int)arg3 enumVerifier:(CDUnknownFunctionPointerType)arg4 extraTextFormatInfo:(const char *)arg5;
+ (id)allocDescriptorForName:(id)arg1 values:(struct PBMessageEnumValueDescription *)arg2 valueCount:(unsigned int)arg3 enumVerifier:(CDUnknownFunctionPointerType)arg4;
