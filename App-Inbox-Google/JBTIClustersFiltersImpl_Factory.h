...
@interface JBTIClustersFiltersImpl_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> itemCumulusAdaptorProvider_;
    id <JavaxInjectProvider> syncedDataElementProducerFactoryProvider_;
    id <JavaxInjectProvider> sectionsFactoryProvider_;
    id <JavaxInjectProvider> filterResultsListFactoryProvider_;
}
