...
@interface JBTEntityListElementProducerFactory : NSObject <ComGoogleAppsBigtopSyncClientImplProducersEntityElementProducerFactory>
{
    ...
    id <ComGoogleAppsXplatPubsubPubSubHub> entityDataChangedPubSubHub_;
}
...
- (id)initWithComGoogleAppsBigtopDataEntitiesMissingEntitiesProto_EntityService_ClientInterface:(id)arg1 withJBTSapiMainThreadHelper:(id)arg2 withComGoogleAppsXplatPubsubPubSubHub:(id)arg3;
