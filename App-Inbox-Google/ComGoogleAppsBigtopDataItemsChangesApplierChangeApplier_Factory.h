...
@interface ComGoogleAppsBigtopDataItemsChangesApplierChangeApplier_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> threadAppliersProvider_;
    id <JavaxInjectProvider> clusterAppliersProvider_;
