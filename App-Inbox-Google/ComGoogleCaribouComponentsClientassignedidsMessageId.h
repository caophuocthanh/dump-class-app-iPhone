...
@interface ComGoogleCaribouComponentsClientassignedidsMessageId : ComGoogleCaribouComponentsClientassignedidsMessageOrThreadId
{
}

+ (const struct J2ObjcClassInfo *)__metadata;
+ (id)__annotations_getMessageIdFromIdStringWithNSString_;
+ (id)__annotations_looksLikeValidIdWithNSString__params;
+ (id)getMessageIdFromIdStringWithNSString:(id)arg1;
+ (id)tryParseIdStringWithNSString:(id)arg1;
