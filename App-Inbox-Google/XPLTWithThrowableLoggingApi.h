...
@class JavaLangThrowable, NSString, XPLTWithLevelLoggingApi;

@interface XPLTWithThrowableLoggingApi : NSObject <XPLTLoggingApi>
{
    XPLTWithLevelLoggingApi *logger_;
...
- (id)getLoggerState;
- (id)getBackend;
- (id)initWithXPLTWithLevelLoggingApi:(id)arg1 withJavaLangThrowable:(id)arg2;
