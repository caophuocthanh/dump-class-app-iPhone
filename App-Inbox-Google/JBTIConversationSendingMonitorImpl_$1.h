...
@class JBTIConversationSendingMonitorImpl, NSString;

@interface JBTIConversationSendingMonitorImpl_$1 : NSObject <ComGoogleAppsBigtopSyncClientImplProducersElementProducer_Listener>
{
...
- (void)dealloc;
- (id)initWithJBTIConversationSendingMonitorImpl:(id)arg1;
