...
@class JavaUtilLoggingLogger, NSString;

@interface ComGoogleCumulusCommonNetLoggingChannelHandler : NSObject <ComGoogleCumulusCommonNetChannel_Handler>
{
...
- (void)onClose;
- (id)initWithJavaUtilLoggingLogger:(id)arg1;
