...
@interface ComGoogleAppsBigtopSyncClientImplProducersProducedForQueryInjectingProducer : ComGoogleAppsBigtopSyncClientImplProducersWrappingElementProducer
{
    ComGoogleAppsBigtopSyncClientImplProducersQueryMetadata *forceProducedForQuery_;
}

+ (const struct J2ObjcClassInfo *)__metadata;
- (void)dealloc;
- (void)setForceProducedForQueryWithComGoogleAppsBigtopSyncClientImplProducersQueryMetadata:(id)arg1;
