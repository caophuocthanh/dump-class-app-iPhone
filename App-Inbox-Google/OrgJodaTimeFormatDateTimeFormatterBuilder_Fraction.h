...
@interface OrgJodaTimeFormatDateTimeFormatterBuilder_Fraction : NSObject <OrgJodaTimeFormatDateTimePrinter, OrgJodaTimeFormatDateTimeParser>
{
    int iMinDigits_;
    int iMaxDigits_;
...
- (id)getFractionDataWithLong:(long long)arg1 withOrgJodaTimeDateTimeField:(id)arg2;
- (void)printToWithJavaLangStringBuffer:(id)arg1 withJavaIoWriter:(id)arg2 withLong:(long long)arg3 withOrgJodaTimeChronology:(id)arg4;
...
- (id)initWithOrgJodaTimeDateTimeFieldType:(id)arg1 withInt:(int)arg2 withInt:(int)arg3;
