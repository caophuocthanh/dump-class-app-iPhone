...
@interface JBTITasksTaskAliasUpdater_LocationAliasListener : NSObject <ComGoogleAppsBigtopSyncClientImplProducersElementProducer_Listener>
{
...
- (void)dealloc;
- (id)initWithJBTITasksTaskAliasUpdater:(id)arg1;
