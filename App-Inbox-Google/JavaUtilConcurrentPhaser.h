...
- (id)description;
- (BOOL)onAdvanceWithInt:(int)arg1 withInt:(int)arg2;
- (BOOL)isTerminated;
- (id)getRoot;
- (id)getParent;
...
- (int)awaitAdvanceInterruptiblyWithInt:(int)arg1 withLong:(long long)arg2 withJavaUtilConcurrentTimeUnitEnum:(id)arg3;
