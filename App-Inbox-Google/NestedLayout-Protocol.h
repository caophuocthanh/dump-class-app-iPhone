...
@protocol NestedLayout <NSObject>
@property(nonatomic) __weak id <NestedLayoutDelegate> layoutDelegate;
- (struct CGPoint)scrollOffsetForScrollable:(id <Scrollable>)arg1 withParent:(id <ParentedScrollable>)arg2;
