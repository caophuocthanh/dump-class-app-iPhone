...
@interface OrgJodaTimeFormatDateTimeFormatterBuilder_CharacterLiteral : NSObject <OrgJodaTimeFormatDateTimePrinter, OrgJodaTimeFormatDateTimeParser>
{
    unsigned short iValue_;
}
