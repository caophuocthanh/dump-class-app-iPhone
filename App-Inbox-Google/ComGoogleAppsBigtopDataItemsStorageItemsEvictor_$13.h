...
@interface ComGoogleAppsBigtopDataItemsStorageItemsEvictor_$13 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
...
- (void)dealloc;
- (id)initWithComGoogleAppsBigtopDataItemsStorageItemsEvictor:(id)arg1 withLong:(long long)arg2 withComGoogleAppsXplatSqlSqlTransaction:(id)arg3;
