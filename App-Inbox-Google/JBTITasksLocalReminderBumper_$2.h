...
@interface JBTITasksLocalReminderBumper_$2 : NSObject <JBTICommonSapiCallback>
{
    JBTITasksLocalReminderBumper *this$0_;
    id <JBTSpan> val$txSpan_;
}

+ (const struct J2ObjcClassInfo *)__metadata;
- (void)dealloc;
- (id)initWithJBTITasksLocalReminderBumper:(id)arg1 withJBTSpan:(id)arg2;
