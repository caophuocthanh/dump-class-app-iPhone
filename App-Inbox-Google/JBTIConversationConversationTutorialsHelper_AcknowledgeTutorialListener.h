...
@interface JBTIConversationConversationTutorialsHelper_AcknowledgeTutorialListener : NSObject <JBTICommonTransaction_CommitListener>
{
...
- (id)initWithJBTIConversationConversationTutorialsHelper:(id)arg1 withJBTTutorial_TypeEnum:(id)arg2;
