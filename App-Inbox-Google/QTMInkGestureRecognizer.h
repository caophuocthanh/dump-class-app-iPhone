...
@property(nonatomic) BOOL cancelOnDragOut; // @synthesize cancelOnDragOut=_cancelOnDragOut;
@property(nonatomic) float dragCancelDistance; // @synthesize dragCancelDistance=_dragCancelDistance;
