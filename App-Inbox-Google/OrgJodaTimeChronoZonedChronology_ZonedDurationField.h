...
- (void)dealloc;
- (long long)addOffsetWithLong:(long long)arg1;
- (int)getOffsetFromLocalToSubtractWithLong:(long long)arg1;
...
- (BOOL)isPrecise;
- (id)initWithOrgJodaTimeDurationField:(id)arg1 withOrgJodaTimeDateTimeZone:(id)arg2;
