...
@interface ComGoogleAppsBigtopDataItemsItemMessageListManager_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> executorProvider_;
    id <JavaxInjectProvider> threadDetailsFetcherProvider_;
    id <JavaxInjectProvider> itemMessageListVersionChangeHubProvider_;
