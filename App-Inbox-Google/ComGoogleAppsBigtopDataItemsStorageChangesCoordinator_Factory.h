...
@interface ComGoogleAppsBigtopDataItemsStorageChangesCoordinator_Factory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> singleItemChangeConvertersProvider_;
