...
+ (void)updateLayout:(id)arg1 animated:(BOOL)arg2 updateBlock:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
- (void).cxx_destruct;
...
- (unsigned int)cellStateMaskForElementWithAttribute:(id)arg1;
- (unsigned int)ordinalPositionForGridElementWithAttribute:(id)arg1;
- (unsigned int)ordinalPositionForListElementWithAttribute:(id)arg1;
...
@property(readonly) QTMCollectionView *collectionView; // @dynamic collectionView;
