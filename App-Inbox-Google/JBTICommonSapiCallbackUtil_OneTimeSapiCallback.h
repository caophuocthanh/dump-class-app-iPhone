...
@interface JBTICommonSapiCallbackUtil_OneTimeSapiCallback : NSObject <JBTICommonSapiCallback>
{
    BOOL isAlreadyCalled_;
    id <JBTICommonSapiCallback> wrappedCallback_;
}
