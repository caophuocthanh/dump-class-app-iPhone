...
@interface ComGoogleAppsBigtopDataCommonRpcRpcSystemInitializer_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> serverRegistryProvider_;
    id <JavaxInjectProvider> jobSchedulerProvider_;
    id <JavaxInjectProvider> serverBindingsProvider_;
    id <JavaxInjectProvider> initialRpcJobsProvider_;
}
