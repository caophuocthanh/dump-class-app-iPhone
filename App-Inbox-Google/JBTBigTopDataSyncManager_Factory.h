...
@interface JBTBigTopDataSyncManager_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> executorProvider_;
    id <JavaxInjectProvider> backgroundSyncPollerFactoryProvider_;
    id <JavaxInjectProvider> subscriptionsByIdProvider_;
