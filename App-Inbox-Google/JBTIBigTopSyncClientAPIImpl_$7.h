...
@interface JBTIBigTopSyncClientAPIImpl_$7 : NSObject <JBTICommonSapiCallback>
{
...
- (void)dealloc;
- (id)initWithJBTIBigTopSyncClientAPIImpl:(id)arg1 withJBTICommonSapiCallback:(id)arg2;
