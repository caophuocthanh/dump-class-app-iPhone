...
@interface ComGoogleAppsBigtopSyncClientImplRpcRequestOrResponseReceiver : NSObject <ComGoogleAppsBigtopSyncClientImplRpcRpcReceiver>
{
...
- (id)initWithComGoogleAppsBigtopSyncClientImplRpcRpcReceiver:(id)arg1 withComGoogleAppsBigtopSyncClientImplRpcRpcReceiver:(id)arg2;
