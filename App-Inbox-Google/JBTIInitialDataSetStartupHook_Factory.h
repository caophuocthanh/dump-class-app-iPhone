...
@interface JBTIInitialDataSetStartupHook_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> dataSetProvider_;
    id <JavaxInjectProvider> loaderProvider_;
    id <JavaxInjectProvider> callbackProvider_;
}
