...
@interface ComGoogleAppsBigtopSyncClientImplSnoozeSnoozeConfigFactoryImpl_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> timeServiceProvider_;
    id <JavaxInjectProvider> snoozePresetsProvider_;
    id <JavaxInjectProvider> sapiSpanFactoryProvider_;
    id <JavaxInjectProvider> smartSnoozeFactoryProvider_;
    id <JavaxInjectProvider> snoozeConfigsProvider_;
    id <JavaxInjectProvider> snoozeMenuFactoryProvider_;
}
