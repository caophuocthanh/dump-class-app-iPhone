...
@interface JBTIBigTopSyncClientAPIImpl_$1 : NSObject <JBTICommonSapiCallback>
{
    JBTIBigTopSyncClientAPIImpl *this$0_;
    id <JBTICommonSapiSpan> val$dataInitSpan_;
    id <JBTICommonSapiCallback> val$sapiCallback_;
}

+ (const struct J2ObjcClassInfo *)__metadata;
- (void)dealloc;
- (id)initWithJBTIBigTopSyncClientAPIImpl:(id)arg1 withJBTICommonSapiSpan:(id)arg2 withJBTICommonSapiCallback:(id)arg3;
