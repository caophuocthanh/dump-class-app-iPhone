...
- (void)dealloc;
- (int)getOffsetToAddWithLong:(long long)arg1;
...
- (BOOL)isLenient;
- (id)initWithOrgJodaTimeDateTimeField:(id)arg1 withOrgJodaTimeDateTimeZone:(id)arg2 withOrgJodaTimeDurationField:(id)arg3 withOrgJodaTimeDurationField:(id)arg4 withOrgJodaTimeDurationField:(id)arg5;
