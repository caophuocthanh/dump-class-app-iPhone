...
@interface JBTISearchZeroStateSuggestionsCache_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> spanFactoryProvider_;
    id <JavaxInjectProvider> schedulerProvider_;
    id <JavaxInjectProvider> searchZeroStateSuggestProvider_;
    id <JavaxInjectProvider> isFetchingDisabledProvider_;
