...
+ (id)XCallbackURLWithScheme:(id)arg1 action:(id)arg2 source:(id)arg3 sourceIconURL:(id)arg4 successURL:(id)arg5 errorURL:(id)arg6 cancelURL:(id)arg7 parameters:(id)arg8 encodeParameters:(BOOL)arg9;
