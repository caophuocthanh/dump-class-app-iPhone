...
#import "JBTCCombinedSegmentSpecifier.h"

@class JBTCTypeIdStringUtil, NSString;

@interface ComGoogleAppsBigtopServicesGmailGmailSegmentSpecifier : NSObject <JBTCCombinedSegmentSpecifier>
{
...
+ (id)__annotations_getRankWithComGoogleCumulusQueryQueryProto_Query_withComGoogleCumulusQueryQueryProto_Result_Segment_withComGoogleCommonBasePair_withNSString_;
