...
@interface ComGoogleAppsBigtopDataLocationaliasesLocationAliasesModule_ProvideEntityRemoteFetcherFactory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> factoryProvider_;
    id <JavaxInjectProvider> entityAdapterProvider_;
}
