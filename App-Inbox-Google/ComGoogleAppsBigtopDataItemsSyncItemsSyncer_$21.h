...
@interface ComGoogleAppsBigtopDataItemsSyncItemsSyncer_$21 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
...
- (void)dealloc;
- (id)initWithComGoogleAppsBigtopDataItemsSyncItemsSyncer:(id)arg1 withComGoogleAppsXplatSqlSqlTransaction:(id)arg2 withJavaUtilList:(id)arg3;
