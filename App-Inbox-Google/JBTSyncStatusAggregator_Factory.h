...
@interface JBTSyncStatusAggregator_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> syncStatusPubSubsProvider_;
    id <JavaxInjectProvider> aggregatedSyncStatusPubSubProvider_;
