...
@protocol ComGoogleCumulusCommonNetReceiveChannel_Handler <NSObject, JavaObject>
- (void)onClose;
...
- (void)onOpenWithComGoogleCumulusCommonUtilCloseable:(id <ComGoogleCumulusCommonUtilCloseable>)arg1;
@end
