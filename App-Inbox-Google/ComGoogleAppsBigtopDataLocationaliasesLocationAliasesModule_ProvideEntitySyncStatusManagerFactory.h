...
@interface ComGoogleAppsBigtopDataLocationaliasesLocationAliasesModule_ProvideEntitySyncStatusManagerFactory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> factoryProvider_;
    id <JavaxInjectProvider> entityStorageProvider_;
    id <JavaxInjectProvider> entityTypeProvider_;
    id <JavaxInjectProvider> entitySyncStatusHubProvider_;
}
