...
- (BOOL)isLenient;
- (id)initWithOrgJodaTimeChronoGJChronology:(id)arg1 withOrgJodaTimeDateTimeField:(id)arg2 withOrgJodaTimeDateTimeField:(id)arg3 withLong:(long long)arg4 withBoolean:(BOOL)arg5;
