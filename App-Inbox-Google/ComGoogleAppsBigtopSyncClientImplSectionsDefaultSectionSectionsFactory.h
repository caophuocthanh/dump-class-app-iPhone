...
@class JBTSection_TypeEnum, NSString;

@interface ComGoogleAppsBigtopSyncClientImplSectionsDefaultSectionSectionsFactory : NSObject <ComGoogleAppsBigtopSyncClientImplSectionsSectionsFactory>
{
...
- (id)initWithJavaUtilComparator:(id)arg1 withComGoogleAppsBigtopSyncClientImplLivelistLiveListImpl_Adaptor:(id)arg2 withJBTSection_TypeEnum:(id)arg3;
