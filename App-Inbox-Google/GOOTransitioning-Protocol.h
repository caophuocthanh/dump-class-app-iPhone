...
@class GOOTransitioningViewLayout, NSArray, UIGestureRecognizer, UIView<GOOTransitioningView>, UIView<GOOTransitioningViewCopying>, UIViewController;
...
- (BOOL)transition:(id <GOOTransition>)arg1 shouldReparentTransitioningView:(UIView<GOOTransitioningView> *)arg2 forKey:(id <NSCopying>)arg3;
