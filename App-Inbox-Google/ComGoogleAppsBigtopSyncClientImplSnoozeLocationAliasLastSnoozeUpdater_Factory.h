...
@interface ComGoogleAppsBigtopSyncClientImplSnoozeLocationAliasLastSnoozeUpdater_Factory : NSObject <DaggerInternalFactory>
{
    id <JavaxInjectProvider> lastSnoozeTrackerProvider_;
    id <JavaxInjectProvider> aliasProducerProvider_;
