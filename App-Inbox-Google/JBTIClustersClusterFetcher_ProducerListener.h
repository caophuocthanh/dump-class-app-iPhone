...
@interface JBTIClustersClusterFetcher_ProducerListener : NSObject <ComGoogleAppsBigtopSyncClientImplProducersElementProducer_Listener>
{
    JBTIClustersClusterFetcher *this$0_;
}

+ (const struct J2ObjcClassInfo *)__metadata;
- (void)dealloc;
- (id)initWithJBTIClustersClusterFetcher:(id)arg1;
