...
@interface OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneOffset : NSObject <OrgJodaTimeFormatDateTimePrinter, OrgJodaTimeFormatDateTimeParser>
{
    NSString *iZeroOffsetPrintText_;
    NSString *iZeroOffsetParseText_;
    BOOL iShowSeparators_;
    int iMinFields_;
    int iMaxFields_;
}
...
- (void)dealloc;
- (int)digitCountWithNSString:(id)arg1 withInt:(int)arg2 withInt:(int)arg3;
...
- (id)initWithNSString:(id)arg1 withNSString:(id)arg2 withBoolean:(BOOL)arg3 withInt:(int)arg4 withInt:(int)arg5;
