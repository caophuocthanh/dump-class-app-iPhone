...
@interface JBTITasksTaskLocationManagerImpl_TaskLocationListener : NSObject <ComGoogleAppsBigtopSyncClientImplProducersElementProducer_Listener>
{
...
- (void)dealloc;
- (id)initWithJBTITasksTaskLocationManagerImpl:(id)arg1;
