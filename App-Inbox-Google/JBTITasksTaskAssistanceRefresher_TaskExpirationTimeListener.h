...
@interface JBTITasksTaskAssistanceRefresher_TaskExpirationTimeListener : NSObject <ComGoogleAppsBigtopSyncClientImplProducersElementProducer_Listener>
{
...
- (void)dealloc;
- (id)initWithJBTITasksTaskAssistanceRefresher:(id)arg1;
