...
@interface OrgJodaTimeFormatDateTimeFormat_StyleFormatter : NSObject <OrgJodaTimeFormatDateTimePrinter, OrgJodaTimeFormatDateTimeParser>
{
    int iDateStyle_;
    int iTimeStyle_;
    int iType_;
...
+ (void)initialize;
- (id)getPatternWithJavaUtilLocale:(id)arg1;
- (id)getFormatterWithJavaUtilLocale:(id)arg1;
