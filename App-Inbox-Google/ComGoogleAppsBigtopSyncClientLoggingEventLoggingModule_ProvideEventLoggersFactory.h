...
@interface ComGoogleAppsBigtopSyncClientLoggingEventLoggingModule_ProvideEventLoggersFactory : NSObject <DaggerInternalFactory>
{
    ComGoogleAppsBigtopSyncClientLoggingEventLoggingModule *module_;
    id <JavaxInjectProvider> loggingManagerProvider_;
    id <JavaxInjectProvider> eventPipelinesProvider_;
}
