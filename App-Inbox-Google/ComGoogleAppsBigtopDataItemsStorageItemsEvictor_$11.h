...
@interface ComGoogleAppsBigtopDataItemsStorageItemsEvictor_$11 : NSObject <ComGoogleCommonUtilConcurrentAsyncFunction>
{
...
- (void)dealloc;
- (id)initWithComGoogleAppsBigtopDataItemsStorageItemsEvictor:(id)arg1 withComGoogleAppsXplatSqlSqlTransaction:(id)arg2 withNSString:(id)arg3;
