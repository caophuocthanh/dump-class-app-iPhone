...
@interface ComGoogleAppsBigtopDataNetworkHttpUrlConnectionTransportModule_ProvideNetworkTransportFactoryFactory : NSObject <DaggerInternalFactory>
{
    ...
    id <JavaxInjectProvider> oAuthManagerProvider_;
}
