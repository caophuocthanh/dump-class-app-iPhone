...
@interface JBTITasksTimeZoneSynchronizer_$3 : NSObject <JBTICommonSapiCallback>
{
...
- (void)dealloc;
- (id)initWithJBTITasksTimeZoneSynchronizer:(id)arg1 withJBTCallback:(id)arg2 withJBTICommonSapiSpan:(id)arg3 withNSString:(id)arg4;
