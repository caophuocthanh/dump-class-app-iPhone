...
@interface OrgJodaTimeFormatDateTimeFormatterBuilder_TwoDigitYear : NSObject <OrgJodaTimeFormatDateTimePrinter, OrgJodaTimeFormatDateTimeParser>
{
...
- (void)dealloc;
- (int)getTwoDigitYearWithOrgJodaTimeReadablePartial:(id)arg1;
...
- (int)getTwoDigitYearWithLong:(long long)arg1 withOrgJodaTimeChronology:(id)arg2;
